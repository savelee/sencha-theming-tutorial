Ext.define('FeedViewer.view.posts.PostsController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.feedposts',
    ...
    onReconfigure: function (postsGrid) {
        var store = postsGrid.getStore();

        if (store.getCount()) {
            postsGrid.getSelectionModel().select(0);
        }
    }
});
