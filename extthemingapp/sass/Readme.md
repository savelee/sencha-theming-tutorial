...
folder are mapped to the application's root namespace, 'ThemingApp'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "ThemingApp"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ThemingApp' in the same way
as `"ThemingApp/sass/src"`.
